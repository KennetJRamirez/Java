package com.agenda.contactos.springboot.agendacontactos.controlador;
...
import com.agenda.contactos.springboot.agendacontactos.repositorio.ContactoRepositorio;
...
public class ContactoControlador {
	...
	public String actualizarContacto(@PathVariable Integer id,@Validated Contacto contacto,BindingResult bindingResult,RedirectAttributes redirect,Model modelo) {
		...
		contactoDB.setTelephone(contacto.getTelephone());
